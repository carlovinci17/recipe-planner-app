...
export const metadata: Metadata = {
  title: { default: "Recipe Planner", template: "%s · Recipe Planner" },
  description: "Centralize, plan, and shop for your household's meals.",
  manifest: "/manifest.webmanifest",
  appleWebApp: { capable: true, statusBarStyle: "default", title: "Recipes" },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning className={cn(inter.variable, display.variable)}>
      <body className="min-h-dvh overflow-x-hidden bg-background font-sans">

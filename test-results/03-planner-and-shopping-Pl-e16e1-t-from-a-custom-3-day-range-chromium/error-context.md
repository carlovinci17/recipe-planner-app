...
- Name: 03-planner-and-shopping.spec.ts >> Planner + shopping list >> builds a shopping list from a custom 3-day range
- Location: tests/e2e/03-planner-and-shopping.spec.ts:68:7
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    5 × unexpected value "http://localhost:3000/onboarding"
    4 × unexpected value "http://localhost:3000/recipes"

...
- Name: 03-planner-and-shopping.spec.ts >> Planner + shopping list >> builds a shopping list from a 7-day range
- Location: tests/e2e/03-planner-and-shopping.spec.ts:42:7

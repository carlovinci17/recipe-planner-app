...
export const shoppingListItems = pgTable("shopping_list_items", {
	...
	unit: text(),
	category: text(),
	sourceRecipeIds: uuid("source_recipe_ids").array().default([""]).notNull(),
...
export const ingestionJobs = pgTable("ingestion_jobs", {
	...
	pageImagePaths: text("page_image_paths").array().default([""]).notNull(),
...
export const recipes = pgTable("recipes", {
	...
	mealTypes: text("meal_types").array().default([""]).notNull(),
	dietTypes: text("diet_types").array().default([""]).notNull(),
	cookingMethods: text("cooking_methods").array().default([""]).notNull(),
	difficulty: text(),
	occasions: text().array().default([""]).notNull(),
...
export const driveFileIndex = pgTable("drive_file_index", {
	...
	recipeTitles: text("recipe_titles").array().default([""]).notNull(),
